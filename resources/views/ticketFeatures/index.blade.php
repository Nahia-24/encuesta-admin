        ...
        <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center sm:flex-nowrap">
            ...
            <div class="mt-3 w-full sm:ml-auto sm:mt-0 sm:w-auto md:ml-0">
                <div class="relative w-56 text-slate-500">
                    <form method="GET" action="{{ route('ticketFeatures.index') }}" class="mt-3 w-full sm:ml-auto sm:mt-0 sm:w-auto md:ml-0">
                        <div class="relative w-56 text-slate-500">
                        ...
                        <x-base.table.tr class="intro-x">
                            ...
                            <x-base.table.td @class([
                                ...
                                <div class="flex items-center justify-center">
                                    ...
                                    <a class="mr-3 flex items-center" href="{{ route('ticketFeatures.edit', ['id' => $ticket->id]) }}">
                                        Editar
                                    </a>
                                    <a
                                        ...
                                        href="{{ route('ticketFeatures.delete', ['id' => $ticket->id]) }}"
                                    >
                                        <x-base.lucide
                                            class="mr-1 h-4 w-4"
                                            icon="Trash"
